...
<div class="container">
    <!-- tittle heading -->
    <h3 class="tittle-w3l">Chi Tiết Hoá Đơn
        <span class="heading-style">
					<i></i>
					<i></i>
					<i></i>
				</span>
    </h3> <!--ket thuc thanh hien thi, chuyen tiep den phanf thong tin hoas don -->
</div>
<!-- //tittle heading -->

<%--    <div class="checkout-right" style="padding-left: 20px">--%>
<table>
    <tr>
        <td style="padding-left: 20px">
            ...
            <div class="table-responsive" style="float: left">
                ...
                <div id="totalBill" align="right">Tổng Tiền: ${total} VND</div> <!-- total bill-->
            </div><!-- list profuct-->
        </td>

        <td style="padding-left: 50px">
            <form action="/payment?action=submit" method="post">
                <fieldset>
                    <p>Tên khách hàng</p>
                    <div>
                        <%--                <input class="input" type="re" value="hêloo">--%>
                            <input name="name" value="${nameCustomer}" >
                    </div>
                    <p> Số điện thoại:</p>
                    <div>
                        <input name="phone" value="${phoneCustomer}" >
                    </div>
                    <p>Địa chỉ giao hàng:</p>
                    <div>
                        <input name="address" value="${addressCustomer}" >
                    </div>
                    <p>
                        Ghi chú nếu có:
                    </p>
                    <div>
                        <input name="note" value="${noteCustomer}">
                    </div>
                    <button  class="input" style="float:left"><a href="/home">Tiếp tục mua hàng</a></button>
                    <button type="submit" class="input" style="float:right">Xác Nhận</button>
                </fieldset>
            </form>
        </td>
