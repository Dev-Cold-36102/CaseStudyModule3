    ...
    <div class="header-bot_inner_wthreeinfo_header_mid">
        ...
        <div class="col-md-8 header">
            ...
            <ul>
                ...
                <li>
                    <a href="/trangchu">
                        <span class="fa fa-unlock-alt" aria-hidden="true"></span><span style="color: blue"> Xin Chào ${userName} </span></a>
                </li>
                <li>
                    <a href="/logout">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body modal-body-sub_agile">
                ...
                <div class="modal_body_left modal_body_left1">
                    ...
                    <form action="/trangchu?action=signup" method="post">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav menu__list">
                                        ...
                                        <div class="col-sm-4 multi-gd-img">
                                            <form action="/trangchu" method="post">
                                                <ul class="multi-column-dropdown">
                                                    <li name="">
                                                        <a href="/trangchu?action=donoithat">Đồ Nội Thất</a>
                                                    </li>
                                                    <li>
                                                        <a href="/trangchu?action=docanhan">Đồ Dùng Cá Nhân</a>
                                                    </li>
                                                    <li>
                                                        <a href="/trangchu?action=quatang">Quà Tặng</a>
                                                    </li>
                                                </ul>
                                                </select>
                                            </form>
                                    ...
                                    <div class="agile_inner_drop_nav_info">
                                        <div class="col-sm-4 multi-gd-img">
                                            <form action="/trangchu" method="post">
                                                <ul class="multi-column-dropdown">
                                                    <li name="">
                                                        <a href="/trangchu?action=banhkeo">Bánh-Kẹo</a>
                                                    </li>
                                                    <li>
                                                        <a href="/trangchu?action=doan">Đồ ăn</a>
                                                    </li>
                                                    <li>
                                                        <a href="/trangchu?action=douong">Đồ Uống</a>
                                                    </li>
                                                </ul>
                                                </select>
                                            </form>
                                    ...
                                    <div class="agile_inner_drop_nav_info">
                                        <div class="col-sm-6 multi-gd-img">
                                            <form action="/trangchu" method="post">
                                                <ul class="multi-column-dropdown">
                                                    <li>
                                                        <a href="/trangchu?action=Bim">Bỉm Và Sữa</a>
                                                    </li>
                                                </ul>
                                            </form>
                                        </div>
                            ...
                            <li class="">
                                <a class="nav-stylehead" href="../user/faqs.jsp">Faqs</a>
                            </li>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu agile_short_dropdown">
                                    <li>
                                        <a href="../user/icons.jsp">Web Icons</a>
                                    </li>
                                    <li>
                                        <a href="../user/typography.jsp">Typography</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="">
                                <a class="nav-stylehead" href="../user/contact.jsp">Liên Hệ</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="item active">
            <div class="container">
                <div class="carousel-caption">
                    ...
                    <a class="button2" href="../user/product.jsp">Shop Now </a>
                </div>
            </div>
        </div>
