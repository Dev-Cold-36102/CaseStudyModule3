...
<div class="ads-grid">
    <div class="container">
        <!-- tittle heading -->
        <h3 class="tittle-w3l">Xóa Sản Phẩm !!!
        ...
        <div class="agileinfo-ads-display col-md-9">
            ...
            <form action="/admin?action=deleteProduct&id=${product.getId()}" method="post">
                <div>
                    <table style="border: 1px solid red">
                        ...
                        <tr>
                            ...
                            <td>${product.getPlaceOfProduct()}</td>
                        </tr>
                        <tr>
                            <td style="background: #d8dcff">số lượng:</td>
                            <td>${product.getAmountProduct()}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>${product.getPriceProductIn()}</td>
                        </tr>
                        <tr>

                            <td style="background: #d8dcff">giá bán:</td>
                            <td>${product.getPriceProductOut()}</td>
                        </tr>
                        <tr>

                            <td style="background: #d8dcff">Size:</td>
                            <td>${product.getMotasp()}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td rowspan="3">${product.getDescribes()}</td>
                        </tr>
                        <tr>

                            <td style="text-align: center"><input  type="submit" value="delete product"></td>
                        </tr>
