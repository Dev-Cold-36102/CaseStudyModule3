...
<div class="ads-grid">
    <div class="container">
        <!-- tittle heading -->
        <h3 class="tittle-w3l">Tìm Kiếm Sản Phẩm Cần Thao Tác !!!
            ...
            <form action="/admin?action=searchProduct" method="post">
                <div>
                    <table style="border: 1px solid red">
                        <tr>
                            <td style="background: #d8dcff">Mã Sản Phẩm:</td>
                            <td><input type="text" name="productCode" placeholder="Nhập mã sản phẩm "></td>
                            <td style="text-align: center"><input  type="submit" value="Tìm Kiếm"></td>
                        </tr>
                    </table>
                </div>
            </form>
