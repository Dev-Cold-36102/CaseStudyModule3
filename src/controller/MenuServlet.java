...
//                break;
    ...
    private void action1(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
        List<Product> list=productService.productListHot("đồ dùng cá nhân");
